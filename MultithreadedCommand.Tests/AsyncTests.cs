...
//        {
//            new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).RemoveAll();
//        }
//        //
//        #endregion
...
//            IAsyncCommandContainer container = new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan());
//            int originalCount = container.Count;

//            ICommand a = new AsyncManager(func.Object, requestId.ToString(), container);

//            Assert.IsTrue(new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Count == originalCount + 1);
//        }
...
//            int originalCount = new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Count;
//            new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).GetContainerItem("", func.Object.GetType()).OnItemRemoved += () => wait.Set();
//            a.Start();

//            //assert
//            wait.WaitOne(3000);

//            int finishedCount = new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Count;
...
//        {
//            var func = new Mock<ICommand>();
//            StaticAsyncCommandContainer container = new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan());
//            IAsyncCommand a = new AsyncManager(func.Object, "", container);
...
//            var container = new Mock<StaticAsyncCommandContainer>(timeSpan.Object) { CallBase = true };
...
//            new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).GetContainerItem("", func.Object.GetType()).OnItemRemoved += () => waitForRemove.Set();
...
//            int newCount = new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Count;
...
//            var timeSpan = new Mock<IAsyncCommandItemTimeSpan>();
//            timeSpan.Setup(t => t.Time).Returns(new TimeSpan(0, 0, 0, 0, 1));
//            StaticAsyncCommandContainer container = new StaticAsyncCommandContainer(timeSpan.Object);
//            IAsyncCommand a = new AsyncManager(func.Object, "", container);
...
//            Assert.IsTrue(originalCount + 1 == new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Count);
//        }
...
//            Assert.IsTrue(originalCount == new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Count);
//        }
...
//            func.Setup(f => f.CoreStart()).Callback(() => new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan()).Remove("", func.Object.GetType()));
...
//            var wait = new ManualResetEvent(false);
//            var func = new Mock<CommandBase> { CallBase = true };
//            var container = new StaticAsyncCommandContainer(new AsyncCommandItemTimeSpan());
//            IAsyncCommand a = new AsyncManager(func.Object, "", container);
//            IAsyncCommandRemover remover = new AsyncCommandRemover(container);
